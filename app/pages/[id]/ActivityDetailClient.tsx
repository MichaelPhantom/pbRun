            ...
            <table className="w-full border-collapse text-center text-[11px] sm:text-sm">
              <thead>
                <tr className="border-b border-zinc-200 dark:border-zinc-700">
                  ...
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">距离<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">km</span></th>
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">配速<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">min/km</span></th>
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">时长<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">min</span></th>
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">心率<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">bpm</span></th>
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">步频<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">spm</span></th>
                  <th className="whitespace-nowrap px-1.5 py-2 text-center font-medium text-zinc-700 dark:text-zinc-300 sm:px-2">爬升<span className="block w-full text-center text-[9px] font-normal text-zinc-400 dark:text-zinc-500">m</span></th>
                </tr>
              </thead>
              <tbody>
                {laps.map((lap) => (
